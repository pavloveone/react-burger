...
export const ordersWsUrl = 'wss://norma.nomoreparties.space/orders';
...
export const refreshToken = `${URL}/auth/token`;  // - эндпоинт обновления токена.
export const user = `${URL}/auth/user`; // эндпоинт получения данных о пользователе.
